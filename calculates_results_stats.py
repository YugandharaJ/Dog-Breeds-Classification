...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_images'] = 0#Z: Images
    results_stats_dic['n_correct_dogs'] = 0#A: Correctly classified dog images
    results_stats_dic['n_dogs_img'] = 0#B: Dog images
    results_stats_dic['n_correct_notdogs'] = 0#C: Correctly classified NOT dog images
    results_stats_dic['n_notdogs_img'] = 0#D: Not Dog Images
    # results_stats_dic['n_match'] = 0
    results_stats_dic['n_correct_breed'] = 0#E: Correctly classified dog breeds       
    ...
    for key in results_dic:
        ...
        #C: Correctly classified NOT dog images 
        ...
        #E: Correctly classified dog breeds 
    ...
    #1_a Percentage of correctly Classified Dog Images
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs']/results_stats_dic['n_dogs_img'])*100 

    #1_b Percentage of correctly classified non-dog images
    ...
    #2 Percentage of correctly classified dog breeds
