...
def check_classifying_images(results_dic):
    ...
    if results_dic is None:
        ...
        for key in results_dic:
            ...
            # else: 
            #     print('Step:', step, 'Key:', key, 'pet_label:', results_dic[key][0], 'classifier:', results_dic[key][1])
        ...
        for key in results_dic:
            ...
            if results_dic[key][2] == 0:
                ...
                print("\n{:>30}: \nReal: {:>26}   Classifier: {:>30}".format(key,
                      results_dic[key][0], results_dic[key][1]))
            # else: 
                # print('Step:', step, 'Key:', key, 'pet_label:', results_dic[key][0], 'classifier:', results_dic[key][1],'Match or Not found')
